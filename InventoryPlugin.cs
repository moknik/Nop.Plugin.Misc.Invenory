...
public class InventoryPlugin : BasePlugin, IMiscPlugin
{
    ...
    public override async Task InstallAsync()
    {
        await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
        {
            ...
            ["Plugins.Misc.Moknik.Inventory.ImportSelectFile"] = "Please select a file to import.",
            ["Plugins.Misc.Moknik.Inventory.ChooseFile"] = "Choose file",
            ["Plugins.Misc.Moknik.Inventory.NoFileSelected"] = "No file selected",
        ...
        if (czechLanguage != null)
        {
            await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
            {
                ...
                ["Plugins.Misc.Moknik.Inventory.ImportSelectFile"] = "Vyberte prosím soubor k importu.",
                ["Plugins.Misc.Moknik.Inventory.ChooseFile"] = "Vybrat soubor",
                ["Plugins.Misc.Moknik.Inventory.NoFileSelected"] = "Nevybrán žádný soubor",
